  ...
  return (
      <div className=" min-h-screen w-full flex flex-col overflow-hidden">
        ...
        <div className=" relative h-screen flex flex-col items-center overflow-y-auto">
          <header className=" max-w-[1520px] w-full sticky top-0 z-50 flex h-14 border-b-[1px] border-zinc-900 bg-zinc-950 items-center justify-between gap-4 bg-secondary p-4 lg:h-[74px] lg:px-6">
