...
export default function Hashbotlist() {
                ...
                <TableCell className="font-medium text-center flex items-center gap-2">
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      ...
                      <Button onClick={() => proccessPayout(item.id,item.username)} className=' bg-yellow-600 rounded-sm w-fit text-sm text-white font-semibold flex items-center justify-center gap-2'>
                        {loading2 === true && (
                          <Spinner/>
                        )}
                        Continue</Button>
