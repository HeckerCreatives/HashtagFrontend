...
export function LineCharts() {
  ...
  const title = graph === 'payin' && 'Payin' || graph === 'comission' && 'Commission' || graph === 'minerpurchased' && 'Hashbot Purchased' || graph === 'minerpayout' && 'Hashbot Payout' || graph === 'unilevelpayout' && 'Unilevel Payout'
         ...
         <CardHeader>
             <div className=" w-full flex items-center justify-between">
                 ...
                 <Select value={type} onValueChange={setType}>
                     <SelectTrigger className=" w-[120px] bg-zinc-950">
