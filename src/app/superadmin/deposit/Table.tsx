...
export default function UserTable() {
  ...
  return (
    <div className=' relative w-full flex flex-col items-center gap-8 max-w-[1440px] h-auto mt-12 bg-zinc-900 p-6'>
        <div className=' flex md:flex-row flex-col gap-4 items-center justify-between absolute top-0 w-[98%] h-auto md:h-[55px] bg-gradient-to-r from-yellow-700 to-yellow-500 p-2 rounded-sm -translate-y-4'>
