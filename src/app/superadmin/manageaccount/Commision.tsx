       ...
       <div className=' flex flex-col gap-1 items-start w-full'>
        ...
        <div className=' w-full flex gap-2 items-center flex-wrap lg:justify-between'>
          <div className=' flex items-center gap-4 flex-wrap'>
            ...
            <input type="date" value={date} onChange={(e) => setDate(e.target.value)} className='bg-zinc-800 text-white p-1 text-xs rounded-sm' />
            </div>

            <div className=' flex items-center gap-1'>
              <label htmlFor="" className=' text-xs text-slate-500'>End date:</label>

              <input type="date" value={end} onChange={(e) => setEnd(e.target.value)} className='bg-zinc-800 text-white p-1 text-xs rounded-sm' />
            </div>
          ...
          <div>
            <input type="text" value={search} onChange={(e) => setSeacrh(e.target.value)} placeholder='Search e.g user 123'  className='bg-zinc-800 text-white p-2 text-xs rounded-sm' />
          </div>
        </div>
