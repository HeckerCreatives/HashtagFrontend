...
export default function WalletHistory() {
  ...
  return (
     <div className=' w-full flex flex-col gap-4 h-auto bg-cream rounded-xl shadow-sm mt-4 p-6'>
        ...
        <SelectContent>
            <SelectItem value="creditwallet">Top Up Balance History</SelectItem>
            <SelectItem value="minecoinwallet">Hashbot Wallet Earning History</SelectItem>
            <SelectItem value="commissionwallet">Commission History(Lvl 2-13)</SelectItem>
        ...
        {(type === 'creditwallet' || type === 'minecoinwallet' || type === 'commissionwallet' || type === 'directcommissionwallet') && (
                    <>
            ...
            <TableBody>
                {list.map((item, index) => (
                    ...
                    {(type === 'directcommissionwallet' || type === 'commissionwallet' ) && (
                          <Dialog>
