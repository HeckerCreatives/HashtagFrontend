...
export default function Cards() {
  ...
  return (
    <div className=' max-w-[1920px] h-auto w-full flex flex-wrap gap-8 mt-6'>
        ...
        <Card icon={<Wallet size={30} />} iconbg={' bg-pink-500'} title={'Referral Total Earnings'} amount={`${stats?.referral.toLocaleString()}`} subtitle={'Total accumulated commission from direct refferal'} text={''} loading={loading}/>
