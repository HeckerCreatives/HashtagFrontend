...
export default function Cards() {
  ...
  return (
    <div className=' max-w-[1920px] h-auto w-full flex flex-wrap gap-8 mt-6'>
        ...
        <Card icon={<Wallet size={30} />} iconbg={' bg-purple-500'} title={'Unilevel Total Commission'} amount={`${wallets?.data.unilevelwallet.toLocaleString()}`} subtitle={'Total accumulated commission from lvl 2 to lvl 13'} text={''} loading={loading}/>
